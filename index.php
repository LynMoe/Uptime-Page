...
define('SITE_NAME',"XiaoLin Services Status");
define('FOOTER',[
    'Home' => 'https://cgl.li',
    'Blog' => 'https://xiaolin.in',
    'Status' => 'https://xll.li',
]);
                ...
                <div class="summary">
                    ...
                    ?>
                        ...
                        <div class="summary-checktime">
                            <?php echo "Last check at " . date('F dS Y, H:i:s',filemtime(__DIR__ . '/data.json')); ?>
                        </div>
                    </div>
                </div>
            </div>
